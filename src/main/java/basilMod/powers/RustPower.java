...
public class RustPower extends AbstractPower implements CloneablePowerInterface, OnReceivePowerPower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("rust84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("rust32.png"));
