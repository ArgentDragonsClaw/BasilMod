...
public class CaffeinePower extends AbstractPower implements CloneablePowerInterface, OnReceivePowerPower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("caffeine84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("caffeine32.png"));
