...
public class BlueRune extends AbstractDynamicCard {


// TEXT DECLARATION

    public static final String ID = BasilMod.makeID(BlueRune.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("BlueRune.png");// "public static final String IMG = makeCardPath("RedRune.png");
