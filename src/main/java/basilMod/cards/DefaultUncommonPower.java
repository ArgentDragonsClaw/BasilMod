...
import basilMod.actions.UncommonPowerAction;
...
public class DefaultUncommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = BasilMod.makeID(DefaultUncommonPower.class.getSimpleName());
