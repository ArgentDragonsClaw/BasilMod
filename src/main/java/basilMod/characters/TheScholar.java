...
import static basilMod.BasilMod.*;
import static basilMod.characters.TheScholar.Enums.BASIL_PURPLE;

//Wiki-page https://github.com/daviscook477/BaseMod/wiki/Custom-Characters
//and https://github.com/daviscook477/BaseMod/wiki/Migrating-to-5.0
//All text (starting description and loadout, anything labeled TEXT[]) can be found in DefaultMod-character-Strings.json in the resources

public class TheScholar extends CustomPlayer {
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_SCHOLAR;
        @SpireEnum(name = "BASIL_PURPLE_COLOR") // These two HAVE to have the same absolutely identical name.
        public static AbstractCard.CardColor BASIL_PURPLE;
        @SpireEnum(name = "BASIL_PURPLE_COLOR") @SuppressWarnings("unused")
    ...
    private static final String ID = makeID("TheScholar");
    ...
    public AbstractPlayer newInstance() {
        return new TheScholar(name, chosenClass);
    }
